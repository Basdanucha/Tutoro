...
class RegisterViewModel @Inject constructor(
    ...
    fun insertUserToFireStoreDB(username: String,
                                email: String,
                                uri: String?,
                                imageId: String?,
                                subject: String?,
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                repo.insertUserToFireStoreDB(username, email, uri, imageId, subject, teachClass, description, phonenumber, lineid, videoUrl, birthday,videoId)
            } catch (e: Exception) {
