...
class ProfileFragment : Fragment(), FirebaseStorageProfilePresenter,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSave.setOnClickListener {
            if (!binding.edUsername.text.isNullOrEmpty()||!binding.edUsername.text.isNullOrEmpty()) {
                loadingAlertDialog.showLoadingAlertDialog()
                if (selectedUri != null) {
    ...
    private fun goToProfileTutorFragment() {
        val action = ProfileFragmentDirections.actionProfileFragmentToProfileTutorFragment()
        findNavController().navigate(action)
    }
