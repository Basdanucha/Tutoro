package com.sameh.chatme.ui.fragments.TutorList.adapter
...
class NewMessageAdapter @Inject constructor(
    ...
    fun setData(usersList: ArrayList<User> , you :String? = null ) {
        this.submitList(you?.let { usersList.filter { it.id != you && it.subject !=null} }?: usersList.filter {  it.subject !=null})
    }
    ...
    inner class ViewHolder(private val binding: UserInRecInNewMessageFragmentBinding) :
        ...
        fun bind(user: User) {
            ...
            binding.tvSubject.text = "Subject: ${user.subject}"
            binding.tvClass.text = "Level: ${user.teachClass}"
